...
export default function Register() {
    ...
    return (
        <div className="min-h-screen text-gray-800">
            ...
            {/* Registration Form */}
            <div className="max-w-lg mx-auto bg-green-100 from-white-100 to-white-400 p-6 md:p-8 rounded-xl shadow-lg mt-24 md:mt-28">
                <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center text-black drop-shadow-lg">
                    {t('Register')}
                </h2>
